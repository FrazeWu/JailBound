    ...
    *,
    ...
    for holdout in holdouts:
        ...
        if rewritten is None:
            raise ValueError(f"could not produce an accepted calibration paraphrase for {candidate.example_id}")
        ...
        if any(
            ...
            raise ValueError("calibration similarity must be a finite probability")
